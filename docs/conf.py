...
example_gallery_config = {
    ...
    'pattern': '*.ipynb',
    'urls': 'https://github.com/agrogeophy/notebooks/master/notebooks',
...
latex_documents = [
    (master_doc, 'growing.tex', 'growing Documentation',
     'agrogeophy', 'manual'),
]
...
man_pages = [
    (master_doc, 'growing', 'growing Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'growing', 'growing Documentation',
     author, 'growing', 'One line description of project.',
     'Miscellaneous'),
]
